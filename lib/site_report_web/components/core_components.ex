defmodule SiteReportWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SiteReportWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SiteReportWeb.Gettext, "errors", msg, opts)
    end
  end
